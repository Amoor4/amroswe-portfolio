...
interface SettingsDocumentData {
  ...
  /**
   * Call Me field in *Settings*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.call_me_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  call_me_link: prismic.LinkField /**
...
export interface ContactSliceDefaultItem {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact.items[].mobile_phone
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  mobile_phone: prismic.KeyTextField;
}
