...
import { FaGithub, FaWhatsapp, FaLinkedin, FaTelegram, FaPhone , FaEnvelope } from "react-icons/fa6";
    ...
    <Bounded as="footer" className="text-slate-600">
      <div className="container mx-auto mt-20 flex flex-col items-center justify-between gap-6 py-8 sm:flex-row ">
        ...
        <div className="socials inline-flex justify-center sm:justify-end">
          ...
          {isFilled.link(settings.data.telegram_link) && (
            <PrismicNextLink
              field={settings.data.telegram_link}
              className="p-2 text-2xl text-slate-300 transition-all duration-150 hover:scale-125 hover:text-yellow-400"
              aria-label={settings.data.name + " on Whatsapp"}
            >
              <FaTelegram />
